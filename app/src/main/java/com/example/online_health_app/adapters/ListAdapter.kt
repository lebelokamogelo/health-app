...
class ListAdapter(
    private var availableDoctorList: MutableList<AvailableDoctor>
) : RecyclerView.Adapter<ListAdapter.AvailableDoctorViewHolder>() {
    ...
    fun filterList(availableList: MutableList<AvailableDoctor>) {
        this.availableDoctorList = availableList
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AvailableDoctorViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.list_doctors, parent, false)
